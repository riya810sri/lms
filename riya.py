...
button5 = Button(button_frame,height=2, text="Exit", command= root.destroy, bg='#FF6347', width=30)
button5.pack(pady=5)
...
l6 = Label(book_issue_frame, image=img4, bg="lightpink")
l6.image = img4
l6.place(x=150,y=30)
...
book_id1 = Label(book_issue_frame, text="BOOK ID:", bg="lightpink", font=("Georgia", 15))
book_id1.place(x=100, y=205)

book_id1_Entry = Entry(book_issue_frame, width=30, fg="#000080", bg="#FFFFE0", font=("Times New Roman", 15, "bold"))
book_id1_Entry.place(x=400, y=200)

book_title1 = Label(book_issue_frame, text="BOOK NAME:", bg="lightpink", font=("Georgia", 15))
book_title1.place(x=100, y=245)

book_title1_Entry = Entry(book_issue_frame, width=30, fg="#000080", bg="#FFFFE0", font=("Times New Roman", 15, "bold"))
book_title1_Entry.place(x=400, y=240)

author_name1 = Label(book_issue_frame, text="AUTHOR NAME:", bg="lightpink", font=("Georgia", 15))
author_name1.place(x=100, y=285)

author_name1_Entry = Entry(book_issue_frame, width=30, fg="#000080", bg="#FFFFE0", font=("Times New Roman", 15, "bold"))
author_name1_Entry.place(x=400, y=280)

student_id2 = Label(book_issue_frame, text="STUDENT ID:", bg="lightpink", font=("Georgia", 15))
student_id2.place(x=100, y=325)

student_id2_Entry = Entry(book_issue_frame, width=30, fg="#000080", bg="#FFFFE0", font=("Times New Roman", 15, "bold"))
student_id2_Entry.place(x=400, y=320)

student_name2 = Label(book_issue_frame, text="STUDENT NAME:", bg="lightpink", font=("Georgia", 15))
student_name2.place(x=100, y=365)

student_name2_Entry = Entry(book_issue_frame, width=30, fg="#000080", bg="#FFFFE0", font=("Times New Roman", 15, "bold"))
student_name2_Entry.place(x=400, y=360)

issue_date1 = Label(book_issue_frame, text="ISSUE DATE:", bg="lightpink", font=("Georgia", 15))
issue_date1.place(x=100, y=405)
...
issue_date1_Entry.place(x=400, y=400)

return_date1 = Label(book_issue_frame, text="RETURN DATE:", bg="lightpink", font=("Georgia", 15))
return_date1.place(x=100, y=445)
...
return_date1_Entry.place(x=400, y=440)
...
l8 = Label(return_book_frame, image=img6, bg="lightpink")
l8.image = img6
l8.place(x=150, y=25)
